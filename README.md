...
|------|-------------|------|---------|:--------:|
| <a name="input_chart"></a> [chart](#input\_chart) | Chart of helm release | `string` | `"aws-load-balancer-controller"` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name of helm release | `string` | `"aws-load-balancer-controller"` | no |
